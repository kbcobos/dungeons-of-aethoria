...
"goblin": EnemyTemplate(
    ...
    xp_reward=40, gold_min=6, gold_max=24,
...
"goblin_shaman": EnemyTemplate(
    ...
    xp_reward=55, gold_min=10, gold_max=36,
...
"giant_rat": EnemyTemplate(
    ...
    xp_reward=25, gold_min=0, gold_max=10,
...
"skeleton": EnemyTemplate(
    ...
    xp_reward=50, gold_min=4, gold_max=20,
...
"orc": EnemyTemplate(
    ...
    xp_reward=90, gold_min=20, gold_max=60,
...
"dark_elf": EnemyTemplate(
    ...
    xp_reward=100, gold_min=30, gold_max=90,
...
"zombie_knight": EnemyTemplate(
    ...
    xp_reward=110, gold_min=40, gold_max=100,
...
"witch": EnemyTemplate(
    ...
    xp_reward=105, gold_min=24, gold_max=80,
...
"vampire": EnemyTemplate(
    ...
    xp_reward=200, gold_min=80, gold_max=200,
...
"stone_golem": EnemyTemplate(
    ...
    xp_reward=220, gold_min=60, gold_max=160,
...
"demon": EnemyTemplate(
    ...
    xp_reward=230, gold_min=70, gold_max=180,
...
"dragon": EnemyTemplate(
    ...
    hp=221, mp=150, attack=16, defense=11, speed=12,
    xp_reward=1000, gold_min=400, gold_max=1000,
    str_stat=25, dex_stat=12, int_stat=18,
    abilities=[
        ("Dragon Breath", 1.6, "burn", 20),
        ("Crushing Claw", 1.3, "stun", 0),
        ("Tail Sweep", 1.1, "aoe", 0),
    ],
...
"lich": EnemyTemplate(
    ...
    hp=166, mp=300, attack=14, defense=8, speed=10,
    xp_reward=900, gold_min=300, gold_max=800,
    str_stat=8, dex_stat=10, int_stat=22,
    abilities=[
        ("Death Ray", 1.7, "freeze", 25),
        ("Raise Dead", 1.0, "summon", 20),
        ("Soul Drain", 1.3, "drain", 18),
    ],
...
"ancient_demon": EnemyTemplate(
    ...
    hp=276, mp=200, attack=20, defense=12, speed=15,
    xp_reward=2000, gold_min=600, gold_max=1600,
    str_stat=22, dex_stat=15, int_stat=20,
    abilities=[
        ("Hellfire Nova", 1.8, "burn", 30),
        ("Void Crush", 1.5, "stun", 25),
        ("Soul Harvest", 1.3, "drain", 20),
    ],
